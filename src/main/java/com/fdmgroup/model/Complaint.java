...
@NamedQueries({ @NamedQuery(name = "complaint.findAll", query = "SELECT c FROM Complaint c"),
		...
		@NamedQuery(name = "complaint.findLastUserComplaint", query = "SELECT c FROM Complaint c WHERE c.complaintID = (SELECT MAX(x.complaintID) FROM Complaint x WHERE x.userID = :id)"),
